(() => {
  ...
  window.XC_SEASON_RESET_APPLIED = false;
  ...
  // Never overwrite a populated device merely because an old migration flag is missing.
  if (previous && Array.isArray(previous.athletes) && previous.athletes.length) {
    localStorage.setItem(RESET_KEY, JSON.stringify({
      adoptedExistingStateAt: new Date().toISOString(),
      athletes: previous.athletes.length,
      results: Array.isArray(previous.results) ? previous.results.length : 0
    }));
    return;
  }

  const highSchool = [
    ['Tony Hernandez', '6:05'], ['Chris Jimnez', ''], ['Yaretzi Prado', ''],
    ['Claire Scoggins', '7:00'], ['Julian Garcia', ''], ['Molly Bloomer', '8:04'],
    ['Paisley Bloomer', '8:14'], ['Daena Salazar', '7:31'], ['Delainy Torres', '8:32'],
    ['Ivan Olvera', '6:50'], ['Lukas Marshall', '6:23'], ['Bianca Aguilar', '8:42'],
    ['Aaron Klump', '6:50'], ['Gerardo Hernandez', ''], ['Katherine Orsorto', ''],
    ['Jackie Arellano', ''], ['Jesus Cordova', '']
  ];

  const juniorHigh = [
    ['Cynthia Hernandez', ''], ['Nicole Hernandez', '8:18'], ['Lia Ayala', '9:09'],
    ['Abel Green', '5:47'], ['Aiden Green', '7:51'], ['Isaac Ates', ''],
    ['Conner Shumate', '11:00'], ['Julian Wario', ''], ['McKaelah Segura', ''],
    ['Miranda Lierra', ''], ['AJ Green', '8:41'], ['Tess Scoggins', '8:31'],
    ['Kynlee Cheek', '10:41'], ['Jaelle Rocha', '9:24'], ['Sumaya Romero', '9:01'],
    ['Aliyah Torres', '8:00'], ['Emmett Thomas', '8:55'], ['Zachary Dunn', '8:00'],
    ['Martin Williams', '8:57'], ['Roan Clark', '6:38'], ['Jameson Nichols', '9:15']
  ];
  ...
  const nextState = {
    ...
    rosterAssignments: {},
    customDistances: [],
    tombstones: { athletes: {}, results: {}, practices: {} }
  };
  ...
  window.XC_SEASON_RESET_APPLIED = true;
